...
for i = 1:length(alpha_grid)
    ...
    while (range(J_bounds) > 1e-6)
        ...
        % CAN'T DO THIS!!!
        o = 1e-6; % Small but finite guess of order parameters
        o1 = o;
        o2 = o;
        o3 = o;
        o4 = o;
        ...
        H_coup = -J*(alpha*(a2*o1c+a_d1*o2-o1c*o2*I4)+...
            gamma*(a1*o4c+a_d4*o1-o4c*o1*I4)+...
            beta*(a4*o3c+a_d3*o4-o3c*o4*I4)+...
            eta*(a3*o2c+a_d2*o3-o2c*o3*I4));
